...
class Customize_Alpha_Color_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script(
			...
			get_stylesheet_directory_uri() . '/customizer/js/alpha-color-picker-customizer.js',
		...
		wp_enqueue_style(
			'alpha-color-picker-customizer',
			get_stylesheet_directory_uri() . '/customizer/css/alpha-color-picker-customizer.css',
